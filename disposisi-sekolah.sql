...
--
-- Name: log_surat_masuk_changes(); Type: FUNCTION; Schema: public; Owner: rpl1
--
...
ALTER FUNCTION public.log_surat_masuk_changes() OWNER TO rpl1;

--
-- Name: set_tanggal_dibaca(); Type: FUNCTION; Schema: public; Owner: rpl1
--
...
ALTER FUNCTION public.set_tanggal_dibaca() OWNER TO rpl1;

--
-- Name: set_waktu_baca_notif(); Type: FUNCTION; Schema: public; Owner: rpl1
--
...
ALTER FUNCTION public.set_waktu_baca_notif() OWNER TO rpl1;

--
-- Name: update_disposisi_aktif(); Type: FUNCTION; Schema: public; Owner: rpl1
--
...
ALTER FUNCTION public.update_disposisi_aktif() OWNER TO rpl1;

--
-- Name: update_updated_at_column(); Type: FUNCTION; Schema: public; Owner: rpl1
--
...
ALTER FUNCTION public.update_updated_at_column() OWNER TO rpl1;
...
--
-- Name: disposisi; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.disposisi OWNER TO rpl1;

--
-- Name: disposisi_id_disposisi_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.disposisi_id_disposisi_seq OWNER TO rpl1;

--
-- Name: disposisi_id_disposisi_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sk; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.distribusi_sk OWNER TO rpl1;

--
-- Name: distribusi_surat_keluar_id_distribusi_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.distribusi_surat_keluar_id_distribusi_seq OWNER TO rpl1;

--
-- Name: distribusi_surat_keluar_id_distribusi_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: jabatan; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.jabatan OWNER TO rpl1;

--
-- Name: jabatan_id_jabatan_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.jabatan_id_jabatan_seq OWNER TO rpl1;

--
-- Name: jabatan_id_jabatan_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: log; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.log OWNER TO rpl1;

--
-- Name: log_aktivitas_id_log_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.log_aktivitas_id_log_seq OWNER TO rpl1;

--
-- Name: log_aktivitas_id_log_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: log_distribusi; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.log_distribusi OWNER TO rpl1;

--
-- Name: notifikasi; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.notifikasi OWNER TO rpl1;

--
-- Name: notifikasi_id_notifikasi_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.notifikasi_id_notifikasi_seq OWNER TO rpl1;

--
-- Name: notifikasi_id_notifikasi_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.riwayat_alur_surat_id_riwayat_seq OWNER TO rpl1;

--
-- Name: riwayat_alur_surat_id_riwayat_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_keluar; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.surat_keluar OWNER TO rpl1;

--
-- Name: surat_keluar_id_surat_keluar_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.surat_keluar_id_surat_keluar_seq OWNER TO rpl1;

--
-- Name: surat_keluar_id_surat_keluar_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk; Type: TABLE; Schema: public; Owner: rpl1
--
...
CREATE TABLE public.surat_masuk (
    ...
    status_alur character varying(50) DEFAULT 'diterima_tu'::character varying,
    updated_at timestamp with time zone DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT chk_status_alur_sm CHECK (((status_alur)::text = ANY ((ARRAY['diterima_tu'::character varying, 'disposisi_kepsek'::character varying, 'diteruskan'::character varying, 'selesai'::character varying])::text[]))),
...
ALTER TABLE public.surat_masuk OWNER TO rpl1;

--
-- Name: surat_masuk_id_surat_masuk_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.surat_masuk_id_surat_masuk_seq OWNER TO rpl1;

--
-- Name: surat_masuk_id_surat_masuk_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: user_jabatan; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.user_jabatan OWNER TO rpl1;

--
-- Name: users; Type: TABLE; Schema: public; Owner: rpl1
--
...
ALTER TABLE public.users OWNER TO rpl1;

--
-- Name: users_id_user_seq; Type: SEQUENCE; Schema: public; Owner: rpl1
--
...
ALTER SEQUENCE public.users_id_user_seq OWNER TO rpl1;

--
-- Name: users_id_user_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi id_disposisi; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sk id_distribusi; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: jabatan id_jabatan; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: log id_log; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: log_distribusi id_riwayat; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: notifikasi id_notifikasi; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk id_surat_masuk; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Name: users id_user; Type: DEFAULT; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: jabatan; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: log; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: log_distribusi; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: notifikasi; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: surat_masuk; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: user_jabatan; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Data for Name: users; Type: TABLE DATA; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi_id_disposisi_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_surat_keluar_id_distribusi_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: log_aktivitas_id_log_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: notifikasi_id_notifikasi_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: riwayat_alur_surat_id_riwayat_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_keluar_id_surat_keluar_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk_id_surat_masuk_seq; Type: SEQUENCE SET; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi disposisi_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sk distribusi_surat_keluar_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: jabatan jabatan_nama_jabatan_key; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: jabatan jabatan_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: log log_aktivitas_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: notifikasi notifikasi_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: log_distribusi riwayat_alur_surat_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_keluar surat_keluar_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk surat_masuk_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: user_jabatan user_jabatan_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: users users_email_key; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: users users_pkey; Type: CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi trg_disposisi_baru; Type: TRIGGER; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sk trg_distribusi_dibaca; Type: TRIGGER; Schema: public; Owner: rpl1
--
...
--
-- Name: notifikasi trg_notifikasi_baca; Type: TRIGGER; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_keluar trg_surat_keluar_updated; Type: TRIGGER; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk trg_surat_masuk_updated; Type: TRIGGER; Schema: public; Owner: rpl1
--
...
--
-- Name: distribusi_sk distribusi_surat_keluar_id_surat_keluar_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi fk_disposisi_kepsek; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi fk_disposisi_penerima; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: disposisi fk_disposisi_surat_masuk; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: log_distribusi fk_riwayat_sk; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: log_distribusi fk_riwayat_sm; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk fk_surat_masuk_disposisi_aktif; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_masuk fk_surat_masuk_verifikasi; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: log log_aktivitas_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: notifikasi notifikasi_id_penerima_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: notifikasi notifikasi_id_pengirim_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: surat_keluar surat_keluar_verifikasi_oleh_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: user_jabatan user_jabatan_id_jabatan_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
...
--
-- Name: user_jabatan user_jabatan_id_user_fkey; Type: FK CONSTRAINT; Schema: public; Owner: rpl1
--
